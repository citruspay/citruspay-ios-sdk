...
+ Download the latest zip file from our [releases page](https://github.com/citruspay/citruspay-ios-sdk/releases) or as a direct [download latest release](https://github.com/citruspay/citruspay-ios-sdk/releases/download/4.0.1/Framework.zip)
+ Unzip the file
+ Or clone it 
~~~{.m}
