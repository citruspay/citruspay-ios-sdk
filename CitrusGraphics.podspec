...
Pod::Spec.new do |s|
  ...
  s.version          = '2.1.0'
  s.summary          = 'A lightweight library for downloading and caching images from the web.'
  ...
  s.source           = { :git => "https://github.com/citruspay/citruspay-ios-sdk.git", :tag => "graphics.2.1.0" }
